...
//!
//! Current baseline: 323/402 (80.3%). The entries below are documented gaps to
...
const KNOWN_FAILURES: &[&str] = &[
    ...
    "2G84/00", "2G84/01", "3HFZ", "5LLU", "5TRB", "5U3A", "9C9N", "9KBC", "9MAG", "9MQT/01", "BS4K",
    "CTN5", "CXX2", "DK4H", "DK95/01", "G5U8", "G9HC", "H7J7", "KS4U", "LHL4", "QB6E", "RXY3",
    "S98Z", "SY6V", "VJP3/00", "W9L4", "X4QW", "Y79Y/000", "Y79Y/003", "Y79Y/004", "Y79Y/005",
    "YJV2", "ZXT5", // -- under-rejected: valid YAML we wrongly reject --
    ...
    "Q5MG", "Q9WF", "S3PD", "S7BG", "S9E8", "SM9W/01", "UKK6/00", "UKK6/01", "V9D5", "W5VH",
    "X8DW", "Z67P",
];
