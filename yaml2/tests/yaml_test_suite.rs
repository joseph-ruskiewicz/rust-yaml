...
//!
//! Current baseline: 337/402 (83.8%). The entries below are documented gaps to
...
const KNOWN_FAILURES: &[&str] = &[
    ...
    "5LLU", "5U3A", "9C9N", "9KBC", "CXX2", "DK4H", "DK95/01", "G9HC", "H7J7", "QB6E", "S98Z",
    "SY6V", "VJP3/00", "W9L4", "Y79Y/000", "Y79Y/003", "Y79Y/004", "Y79Y/005", "ZXT5",
