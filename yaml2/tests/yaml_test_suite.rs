...
//!
//! Current baseline: 380/402 (94.5%). The entries below are documented gaps to
...
const KNOWN_FAILURES: &[&str] = &[
    ...
    "9C9N", "9KBC", "CXX2", "DK4H", "DK95/01", "G9HC", "H7J7", "QB6E", "VJP3/00", "Y79Y/000",
    "Y79Y/003", "ZXT5", // -- under-rejected: valid YAML we wrongly reject --
    "2SXE", "58MP", "5T43", "AB8U", "CT4Q", "DBG4", "LX3P", "M2N8/01", "Q9WF", "W5VH",
];
