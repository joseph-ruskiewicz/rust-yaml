...
//!
//! Current baseline: 369/402 (91.8%). The entries below are documented gaps to
...
const KNOWN_FAILURES: &[&str] = &[
    ...
    "W9L4", "Y79Y/000", "Y79Y/003", "ZXT5",
    // -- under-rejected: valid YAML we wrongly reject --
    "2SXE", "4WA9", "58MP", "5T43", "AB8U", "CT4Q", "D83L", "DBG4", "F6MC", "KK5P", "LX3P",
    "M2N8/01", "M5C3", "M5DY", "Q9WF", "V9D5", "W5VH", "Z67P",
];
