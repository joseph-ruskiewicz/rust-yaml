...
//!
//! Current baseline: 345/402 (85.8%). The entries below are documented gaps to
...
const KNOWN_FAILURES: &[&str] = &[
    ...
    "2EBW", "2SXE", "2XXW", "35KP", "4WA9", "58MP", "5T43", "5WE3", "6CA3", "6M2F", "6PBE", "7W2P",
    "A2M4", "AB8U", "AZW3", "CT4Q", "D83L", "DBG4", "DK95/00", "F6MC", "FBC9", "GH63", "JTV5",
    "KK5P", "L94M", "LX3P", "M2N8/00", "M2N8/01", "M5C3", "M5DY", "PW8X", "Q5MG", "Q9WF", "S7BG",
    "S9E8", "UKK6/01", "V9D5", "W5VH", "X8DW", "Z67P",
];
